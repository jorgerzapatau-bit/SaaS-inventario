                                    ...
                                    {(plantilla.fechaPrimerRegistro || plantilla.fechaUltimoRegistro) && (() => {
                                        ...
                                        return (
                                            <div className="col-span-2">
                                                <p className="text-[10px] text-gray-400 mb-1">Fechas detectadas desde registros diarios:</p>
                                                <button
                                                    type="button"
                                                    onClick={() => setForm(f => ({
                                                        ...f,
                                                        fechaInicio: plantilla.fechaPrimerRegistro ?? f.fechaInicio,
                                                        fechaFin:    plantilla.fechaUltimoRegistro ?? f.fechaFin,
                                                    }))}
                                                ...
                                                >
                                                    ...
                                                    {fmtD(plantilla.fechaPrimerRegistro)}
                                                    <span className="text-blue-400 font-normal">→</span>
                                                    {fmtD(plantilla.fechaUltimoRegistro)}
                                                </button>
                                            </div>
                                        );
                                    })()}

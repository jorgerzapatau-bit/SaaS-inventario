                                    ...
                                    {(plantilla.fechaPrimerRegistro || plantilla.fechaUltimoRegistro) && (
                                        <div className="col-span-2">
                                            <button
                                                ...
                                                className="w-full flex items-center justify-center gap-1.5 px-3 py-2 text-xs font-medium text-blue-600 bg-blue-50 hover:bg-blue-100 border border-blue-200 rounded-lg transition-colors"
                                            >
                                                ...
                                                Usar fechas de registros diarios

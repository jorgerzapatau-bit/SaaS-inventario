...
function LoginForm() {
    ...
    if (loadingCompany) return (
        <div className="min-h-screen bg-gray-900 flex items-center justify-center">
            <div className="w-8 h-8 border-4 border-gray-100 border-t-transparent rounded-full animate-spin"/>
        </div>
    );
                ...
                <div className="px-10 py-7">
                    ...
                    <form onSubmit={handleLogin} className="space-y-4">
                        <div>
                            ...
                            <input
                                ...
                                className="w-full px-4 py-3 border border-gray-200 rounded-xl text-sm text-gray-800 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-400/30 focus:border-gray-600 transition-all placeholder-gray-300"
                            />
                        </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    placeholder="••••••••"
                                    className="w-full px-4 py-3 border border-gray-200 rounded-xl text-sm text-gray-800 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-400/30 focus:border-gray-600 transition-all placeholder-gray-300 pr-12"
                                />
                        ...
                        <button type="submit" disabled={loading || !companyInfo}
                            className="w-full py-3.5 px-4 bg-gray-900 hover:bg-black active:bg-gray-800 text-white font-semibold rounded-xl shadow-md shadow-black/25 transition-all disabled:opacity-60 text-sm mt-2">
                            {loading ? (
                    ...
                    {!companySlug && (
                        <div className="mt-5 text-center text-xs text-gray-400 space-y-1">
                            ...
                            <p>Ej: <span className="font-mono text-gray-600">localhost:3000/login?company=demo</span></p>
                        </div>
                    )}
                </div>
            </div>
